...
<template>
    ...
    <Head title="JenisImunisasi" />

    <AuthenticatedLayout>
        <template #header>
            <h2>Data JenisImunisasi</h2>
        </template>

        <div class="py-4 relative box-content">
            <SingleTable @update:search="search = $event" @update:order="order" :slug="null" path="JenisImunisasi" :TableData="data" :tableColums="table_colums" :crud="crud" >
