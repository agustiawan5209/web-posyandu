                            ...
                            <div class="col-span-full  ">
                                ...
                                <table class="w-full table">
                                    ...
                                    <tr class="">
                                        ...
                                        <td>:</td>
                                        <td class="text-sm border-b text-gray-600"> {{ posyandus.usia }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="text-sm border-b py-2 font-bold capitalize">Tanggal</td>
                                        <td>:</td>
                                        <td class="text-sm border-b text-gray-600"> {{ posyandus.posyandus }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="text-sm border-b py-2 font-bold capitalize">jenis imunisasi</td>
                                        <td>:</td>
                                        <td class="text-sm border-b text-gray-600"> {{ posyandus.jenis_imunisasi }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="text-sm border-b py-2 font-bold capitalize">penanggung jawab</td>
                                        <td>:</td>
                                        <td class="text-sm border-b text-gray-600"> {{ posyandus.penanggung_jawab }} </td>
                                    </tr>
                                    <tr class="">
                                        <td class="text-sm border-b py-2 font-bold capitalize">deskripsi</td>
                                        <td>:</td>
                                        <td class="text-sm border-b text-gray-600 text-left" v-html="posyandus.deskripsi"> </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
