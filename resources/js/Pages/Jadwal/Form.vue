                    ...
                    <fieldset class="grid grid-cols-3 gap-6 p-6 rounded-md shadow-sm bg-gray-50 relative box-content">
                        <div class="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                            ...
                            <div class="col-span-full sm:col-span-2">
                                ...
                                <TextInput id="tanggal" type="date" v-model="Form.tanggal" placeholder="tanggal..." class="w-full text-gray-900"  />
                            ...
                            <div class="col-span-full relative box-content">
                                ...
                                <quill-editor id="deskripsi"  contentType="html" theme="snow"  v-model:content="Form.deskripsi" placeholder="@deskripsi" class="w-full h-full text-gray-900 relative"  />
