...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-4 relative box-content">
            <CardTable @update:search="search = $event" @update:order="order" :slug="null" path="Jadwal" :TableData="data" :tableColums="table_colums" :crud="crud" :datereport="datereport" />
        </div>
    </AuthenticatedLayout>
</template>
