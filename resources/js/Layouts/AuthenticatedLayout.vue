    ...
    <aside
        ...
        <div>
            <div class="mt-8 text-center">
                ...
                <h5 class="mt-4 hidden text-xl font-semibold text-gray-600 lg:block">{{ $page.props.auth.user.name }}
                </h5>
                <span class="hidden text-gray-400 lg:block">{{ $page.props.auth.role.name }}</span>
            </div>

            <ul class="mt-8 space-y-2 tracking-wide">
                <li>
                    <Link href="#" aria-label="dashboard"
                        class="relative flex items-center space-x-4 rounded-xl bg-gradient-to-r from-primary to-green-400 px-4 py-3 text-white">
                        <svg class="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
                            <path
                                d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z"
                                class=" fill-current text-green-400"></path>
                            <path d="M13 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8Z"
                                class="fill-current text-green-200 group-hover:text-green-300"></path>
        ...
        <div class="-mx-6 flex items-center justify-between border-t px-6 pt-4">
            <Link :href="route('logout')" method="post" as="button" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                ...
                <div class="flex space-x-4">
                    ...
                    <div hidden class="md:block">
                        <div class="relative flex items-center text-gray-400 focus-within:text-green-400">
                            <span
                                class="absolute left-4 flex h-6 items-center border-r border-gray-300 pr-3">
