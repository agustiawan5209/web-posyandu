    ...
    <aside
        ...
        <div>
            <div class="mt-8 text-center">
                ...
                <h5 class="mt-4 hidden text-xl font-semibold text-gray-600 lg:block dark:text-gray-300">Cynthia J. Watts
                </h5>
                <span class="hidden text-gray-400 lg:block">{{ $page.props.auth.user.name }}</span>
            </div>
        ...
        <div class="-mx-6 flex items-center justify-between border-t px-6 pt-4 dark:border-gray-700">
            <Link :href="route('logout')" method="post" as="button" class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-gray-300">
